...
namespace ExampleObjectDetection
{
	class Program
	{
		...
		{
			string defaultModelUrl = ConfigurationManager.AppSettings.Value["DefaultModelUrl"] ?? throw new ConfigurationErrorsException("'DefaultModelUrl' setting is missing in the configuration file");
		...
		{
			string defaultTextsUrl = ConfigurationManager.AppSettings.Value ["DefaultTextsUrl"] ?? throw new ConfigurationErrorsException ("'DefaultTextsUrl' setting is missing in the configuration file");
